...
export default function ComprarLibroPage() {
  ...
  useEffect(() => {
    if (!loadingUser && !user) router.push("/login?redirect=/comprar-libro/nutricion-del-bebe");
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 md:py-12">
        <div className="grid lg:grid-cols-[1fr_380px] gap-8 lg:gap-10">
          ...
          <div>
            ...
            <p className="font-nunito text-[#5a7255] mb-6 text-sm">
              Llena este formulario y María Luisa coordinará contigo por WhatsApp.
            </p>

            {/* Alternativa: compra directa en Hotmart */}
            <a
              href={HOTMART_LINK}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 mb-10 px-5 py-3 rounded-full border-2 border-[#FF6600] text-[#FF6600] font-semibold text-sm hover:bg-[#FF6600] hover:text-white transition"
            >
              🔥 Comprar en Hotmart
            </a>
            ...
            <div className="bg-white rounded-2xl border border-[#C5DFC5] p-4 sm:p-6">
              ...
              <div className="flex gap-4 pb-4 border-b border-[#C5DFC5]">
                <div className="relative w-16 h-20 bg-[#f0f8ec] rounded-xl overflow-hidden flex-shrink-0">
                  ...
                  {/* Sello Hotmart */}
                  <span className="absolute top-0.5 right-0.5 bg-[#FF6600] text-white text-[8px] font-bold px-1.5 py-0.5 rounded-full leading-tight text-center shadow">
                    🔥 Hotmart
                  </span>
                </div>
              ...
              <div className="hidden lg:block space-y-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full flex items-center justify-center gap-2 border-2 border-[#FF6600] text-[#FF6600] px-6 py-3 rounded-full transition font-semibold hover:bg-[#FF6600] hover:text-white font-nunito text-sm"
                >
                  🔥 Comprar en Hotmart
                </a>
              </div>
